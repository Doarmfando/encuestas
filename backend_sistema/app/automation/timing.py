...
EXECUTION_PROFILES = {
    "fast": {
        ...
        "nav_wait_timeout_s": 3.0,
        "submit_confirm_timeout_s": 6.0,
        "poll_interval_s": 0.10,
    },
    "turbo": {
        "label": "Turbo",
        "description": "Modo ultra rapido tras validacion previa en balanced.",
        "survey_pause_min": 0.00,
        "survey_pause_max": 0.05,
        "action_pause_min": 0.00,
        "action_pause_max": 0.02,
        "settle_pause_min": 0.00,
        "settle_pause_max": 0.03,
        "ready_wait_timeout_s": 3.0,
        "nav_wait_timeout_s": 1.5,
        "submit_confirm_timeout_s": 3.0,
        "poll_interval_s": 0.05,
    },
    "turbo_plus": {
        "label": "Turbo+",
        "description": "Aun mas agresivo que Turbo. Usa waits minimos.",
        "survey_pause_min": 0.00,
        "survey_pause_max": 0.02,
        "action_pause_min": 0.00,
        "action_pause_max": 0.01,
        "settle_pause_min": 0.00,
        "settle_pause_max": 0.02,
        "ready_wait_timeout_s": 1.0,
        "nav_wait_timeout_s": 0.8,
        "submit_confirm_timeout_s": 1.5,
    ...
    "balanced": {
        ...
        "ready_wait_timeout_s": 8.0,
        "nav_wait_timeout_s": 4.0,
