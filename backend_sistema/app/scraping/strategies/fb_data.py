...
from app.constants.question_types import (
    ...
    TIPO_SECCION, TIPO_IMAGEN, TIPO_INFORMATIVO, TIPO_ARCHIVO, TIPO_ESCALA_LINEAL,
...
class FBDataStrategy:
    ...
    def _parsear_item(self, item):
        ...
        try:
            ...
            # Google Forms a veces pone el texto de la pregunta en descripcion (item[2])
            # con titulo vacio (item[1] = None). Esto pasa cuando el creador del formulario
            # escribe en el campo "descripcion" en lugar del "titulo".
            ...
            # Tipos decorativos: imagen se descarta; informativo se conserva
            if tipo == TIPO_IMAGEN:
                return None
            if tipo == TIPO_INFORMATIVO:
                texto_info = titulo or descripcion
                if not texto_info:
                    return None
                return {
                    "texto": texto_info,
